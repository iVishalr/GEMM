...
void AddDot4x4(int k, double *a, int lda, double *b, int ldb, double *c, int ldc){
    ...
    register double c_00, c_01, c_02, c_03, c_10, c_11, c_12, c_13, c_20, c_21, c_22, c_23, c_30, c_31, c_32, c_33, a_0p, a_1p, a_2p, a_3p;
...
int main(){
    ...
    printf("Optimization 8 : Dot product took %f seconds GFLOPS : %f\n",duration,gflops/duration);
    return 0;
}